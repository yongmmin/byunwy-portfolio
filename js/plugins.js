  ...
  $.each(e, function (e, o) {
    var n = $(o),
      ...
      l = new ScrollMagic.Scene({
        ...
        .addTo(s)
        .on("enter", function (e) {
          $(".navigation-icon .lines").addClass("lines-color-switch"),
            $("#menu-mobile").addClass("menu-mobile-dark"),
            $(".lines").addClass("lines-close-light");
        })
        .on("leave", function (e) {
          $(".navigation-icon .lines").removeClass("lines-color-switch"),
            $("#menu-mobile").removeClass("menu-mobile-dark"),
            $(".lines").removeClass("lines-close-light");
        });
...
jQuery(function (a) {
  a("body").html(),
    a("#menu-mobile-caller").on("click", function () {
      ($menuCaller = a(this)),
        ($mainMenu = a("#menu-mobile")),
        $mainMenu.hasClass("activated")
          ? $mainMenu.find("a").fadeOut("fast", function () {
